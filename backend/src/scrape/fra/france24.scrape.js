...
export const scrapeFrance = asyncHandler(async () => {
    try {
        ...
        await page.goto('https://www.lexpress.fr/politique/', { waitUntil: 'networkidle2' });

        const containerSelector = "#fusion-app > div.sous-home > div.sous-home__body";
        ...
        const selectors = [
            ...
            },
            {
                ...
                link: "article:nth-child(2) > div.thumbnail__image.link--unstyled > a",
            ...
            },
            {
                ...
                link: "article:nth-child(3) > div.thumbnail__image.link--unstyled > a",
            ...
            },
            {
                ...
                link: "article:nth-child(6) > div.thumbnail__image.link--unstyled > a",
